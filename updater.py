...
def deleter(id):
  try:
    ...
    return error
  return f'All correspondence of activity id {id} deleted'
...
def shop_inserter(item_id,shop_name,shop_id,price):
  try:
    ...
    return error
  return f"Inserted item_id{item_id}, shop_name:'{shop_name}', shop_id:{shop_id}, price:{price} to shop"
...
def item_inserter(act_id,item_id,item_name):
  try:
    ...
    return error
  return f"Inserted act_id:{act_id}, item_id:{item_id}, item_name:{item_name} to item"
